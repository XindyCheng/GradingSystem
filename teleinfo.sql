...
CREATE TABLE `PM_entry`  (
	...
	`contract_number` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '合同编号',
	...
	`state` smallint(6) NULL DEFAULT 0 COMMENT '项目状态（0：在途 1：结束）',
